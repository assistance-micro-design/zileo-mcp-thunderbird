 ...
 * List calendars
 */
export async function handleCalendarsList(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.CALENDARS_LIST, {});
 ...
 */
export async function handleCalendarsGet(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.CALENDARS_GET, params);
 ...
 * Search events
 */
export async function handleEventsSearch(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.EVENTS_SEARCH, params);
...
export async function handleEventsList(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.EVENTS_LIST, params);
...
export async function handleEventsGet(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.EVENTS_GET, params);
 ...
 * Create an event
 */
export async function handleEventsCreate(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.EVENTS_CREATE, params);
 ...
 * Update an event
 */
export async function handleEventsUpdate(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.EVENTS_UPDATE, params);
...
export async function handleEventsMove(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.EVENTS_MOVE, params);
 ...
 * Delete an event
 */
export async function handleEventsDelete(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.EVENTS_DELETE, params);
...
export const calendarTools: McpTool[] = [
  ...
  },
  {
    ...
    description: '(EXPERIMENTAL) Get detailed information about a specific calendar',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: '(EXPERIMENTAL) Search for events across calendars within a date range',
    inputSchema: {
      type: 'object',
      properties: {
        query: { type: 'string', description: 'Search query (title, location, description)' },
        calendarId: { type: 'string', description: 'Optional: limit to specific calendar' },
  ...
  },
  {
    ...
    description: '(EXPERIMENTAL) List events in a specific calendar within a date range',
    inputSchema: {
      type: 'object',
      properties: {
        calendarId: { type: 'string', description: 'Calendar ID' },
  ...
  },
  {
    ...
    description: '(EXPERIMENTAL) Get detailed information about a specific event',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: '(EXPERIMENTAL) Create a new calendar event with optional recurrence',
    inputSchema: {
      type: 'object',
      properties: {
        calendarId: { type: 'string', description: 'Calendar ID to create event in' },
        title: { type: 'string', description: 'Event title (1-500 characters)' },
        start: { type: 'string', description: 'Start date/time (ISO 8601)' },
        end: { type: 'string', description: 'End date/time (ISO 8601)' },
        location: { type: 'string', description: 'Event location (optional, max 500 chars)' },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        start: { type: 'string', description: 'New start date/time (ISO 8601) (optional)' },
        end: { type: 'string', description: 'New end date/time (ISO 8601) (optional)' },
        ...
        scope: {
          ...
          description: 'For recurring events: this (single), all (all occurrences), future (this and future)',
          default: 'this'
        },
      },
      required: ['eventId', 'calendarId'],
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        calendarId: { type: 'string', description: 'Calendar ID' },
        newStart: { type: 'string', description: 'New start date/time (ISO 8601)' },
