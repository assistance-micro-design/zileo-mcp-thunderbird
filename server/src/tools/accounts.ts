 ...
 * List all accounts
 */
export async function handleAccountsList(args: unknown): Promise<ToolCallResult> {
  try {
 ...
 * Get account details
 */
export async function handleAccountsGet(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.ACCOUNTS_GET, params);
 ...
 */
export async function handleIdentitiesList(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.IDENTITIES_LIST, params);
