 ...
 * Search contacts
 */
export async function handleContactsSearch(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.CONTACTS_SEARCH, params);
 ...
 */
export async function handleContactsList(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.CONTACTS_LIST, params);
 ...
 */
export async function handleContactsGet(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.CONTACTS_GET, params);
 ...
 */
export async function handleContactsCreate(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.CONTACTS_CREATE, params);
 ...
 * Update a contact
 */
export async function handleContactsUpdate(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.CONTACTS_UPDATE, params);
 ...
 * Delete a contact
 */
export async function handleContactsDelete(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.CONTACTS_DELETE, params);
 ...
 * List address books
 */
export async function handleAddressBooksList(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.ADDRESSBOOKS_LIST, {});
 ...
 */
export async function handleAddressBooksCreate(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.ADDRESSBOOKS_CREATE, params);
 ...
 */
export async function handleAddressBooksDelete(args: unknown): Promise<ToolCallResult> {
  try {
    ...
    const response = await client.sendRequest(MessageActions.ADDRESSBOOKS_DELETE, params);
...
export const contactTools: McpTool[] = [
  {
    ...
    description: 'Search for contacts across address books by name, email, or other properties',
    inputSchema: {
      type: 'object',
      properties: {
        query: { type: 'string', description: 'Search query (name, email, company, etc.)' },
        addressBookId: { type: 'string', description: 'Optional: limit search to specific address book' },
        limit: { type: 'number', description: 'Maximum results (default: 50, max: 500)', default: 50 },
      },
      required: ['query'],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        offset: { type: 'number', description: 'Number of contacts to skip (default: 0)', default: 0 },
      },
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        addressBookId: { type: 'string', description: 'Address book ID to add contact to' },
        properties: {
          type: 'object',
          description: 'Contact properties (DisplayName, PrimaryEmail, FirstName, LastName, etc.)',
          additionalProperties: { type: 'string' },
        },
        vCard: { type: 'string', description: 'vCard 4.0 format (alternative to properties)' },
      },
      required: ['addressBookId'],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        vCard: { type: 'string', description: 'Complete vCard 4.0 format (replaces all properties)' },
      },
      required: ['contactId'],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        name: { type: 'string', description: 'Address book name (1-255 characters)' },
      },
      required: ['name'],
    },
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        addressBookId: { type: 'string', description: 'Address book ID to delete' },
      },
      required: ['addressBookId'],
    },
  },
