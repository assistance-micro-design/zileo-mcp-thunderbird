...
This file lists all third-party dependencies present in the resolved dependency tree of Zileo MCP — Thunderbird, along with their declared licenses, as required by the Apache License 2.0 Section 4 (attribution).
...
| @zileo-mcp-thunderbird/server         | 1.3.1    | Apache-2.0    |                                                           |
...
3. **Modifications**: Zileo MCP — Thunderbird does not modify any third-party library source code.
